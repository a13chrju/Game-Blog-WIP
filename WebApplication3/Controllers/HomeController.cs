...
namespace WebApplication3.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult page(int id)
        {
            ...
            MySqlConnection con = new MySqlConnection();
            con.ConnectionString = ConfigurationManager.ConnectionStrings["test"].ToString();
            MySqlCommand fetchdata = new MySqlCommand("SELECT har_tagg.post_id,Tagg.namn FROM har_tagg where har_tagg.tagg_id = @idtag", con);
            fetchdata.Parameters.AddWithValue("@idtag", id);
            con.Open();
            MySqlDataReader r = fetchdata.ExecuteReader();
            bloggs blogg = new bloggs();
